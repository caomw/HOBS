...
From Figure~\ref{fig:study2}, we can see that the overall target aquisition time has decreased from 4.31 seconds for {\em Naive IR} to 3.64 second for {\em Intensity IR}. This difference is also significant ($t(555)=3.2945$, $p=0.001$.) \bjoern{for consistency's sake, can we show a box plot as in figure 5?} \ben{I think cdf is a better way than boxplot? It actually provides more information. I may consider using cdf consistently.}
