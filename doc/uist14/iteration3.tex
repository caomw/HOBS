...
Before we describe how this new technique works. The relative orientation information -- {\em adjacent map} -- has to be learned before we can use it. Such a learning process can either be performed a prior, or through demonstration. \ben{need better elaboration here}.
