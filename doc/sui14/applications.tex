...
\changes{While our system enabled users to select and control the example devices successfully, work remains in devising appropriate interfaces for complex devices. Users rated ease of use higher for the lamp and fan which had simple, discrete on/off actions, and lower for the TV control, which had more options. Multiple participants remarked that the difficulty was based on the affordances of Glass: \studyquote{Most of the difficulty I had with Glass came from having to navigate the interface on the tiny screen with the touch pad}. 
