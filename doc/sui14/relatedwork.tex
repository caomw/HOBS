...
\cite{bacim2013design}. All area and space cursors necessitate disambiguation when there are multiple potential targets and no clear winner. This paper describes the trade-offs between several disambiguation approaches.
