...
technique does not require a static map ahead of time. \changes{In the FreeMote
system, \cite{hipp2009universal} an IR camera in a handheld controller interprets readings from IR emitters on target appliances. In contrast, we explore a lower cost alternative, using only IR emitters and receivers. }
