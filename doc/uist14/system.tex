...
Using such an architecture for communication also makes the integration with Google Glass easier. For now, Google Glass is capable of WiFi and Bluetooth; so we have added a Bluetooth modem to establish connections with Google Glass. We use BlueSMiRF Silver (WRL-12577) for our prototype. 
...
\caption{we should replace this placeholder with Claire's design and printed version.}
\label{fig:3d-holder}
\end{figure}
