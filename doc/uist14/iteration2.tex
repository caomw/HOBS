...
\caption{The current environment setup \ben{needs annotation and a better photo.} \bjoern{yes}.. blackboard is 2*107+122 cm , 183 cm dimension.}
...
%% resolved: \bjoern{for consistency's sake, can we show a box plot as in figure 5?} \ben{I think cdf is a better way than boxplot? It actually provides more information. I may consider using cdf consistently.}
