...
\caption{Targeting interaction: when users turn towards a controllable appliance (A->B), the appliance shows immediate visual feedback (B). Users confirm that they wish to connect to this appliance with a tap (C) which triggers connection feedback on the appliance.}
...
% \begin{figure}[t!]
% \centering
% \includegraphics[width=0.5\columnwidth]{figures/screenshot_LAMP_CONTROL.png}
% \caption{ }
...
% \begin{figure}[t!]
% \centering
% \includegraphics[width=0.5\columnwidth]{figures/screenshot_TV_CONTROLS.png}
% \caption{( devices. }
