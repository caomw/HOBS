...
\author{
 \alignauthor Anonymous for submission\\
  ...
  \email{benzh@eecs.berkeley.edu, sean.yhc@gmail.com, clairetuna@berkeley.edu, achal@berkeley.edu, yangli@acm.org, eal@eecs.berkeley.edu, bjoern@eecs.berkeley.edu}
  }
}
...
\vspace{-0.05in}
\keywords{
  Wearable computing; selection; glass; infrared
}
\vspace{-0.1in}
