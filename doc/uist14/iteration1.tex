...
\caption{Boxplot of target acquisition time for {\em IR selection} and {\em list selection} is shown on the left. The center of each box is the median value, while we annotate the mean value using white dashed lines. The cumulative distributions are shown on the right.}
