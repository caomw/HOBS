...
Though such head orientation targeting enables a wide range of context-aware applications, in this paper we focus on our GlassRemote system that we have built using the existing hardware platform to achieve a universal smart appliance control functionality.
