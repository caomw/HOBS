...
Performance of the {\em Naive IR} technique will degrade as target density in an environment increases, as increased density will require refinement steps. We therefore ask a follow-on research question: {\em``How might we improve selection time in a dense environment?’’}
