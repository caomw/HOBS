...
\title{\systemnamenospace: Head orientation-based target selection\\in physical spaces}
...
\teaser{
  \centering
  \includegraphics[width=\textwidth]{figures/new_teaser.pdf}
  \caption{\ben{needs further refinement of this image. It's in Figures/figures.key.} Illustration of head-orientation based targeting and an example application -- Universal Remote Control.}
  \label{fig:teaser}
}
