...
We recruited 14 participants from our institution. 13 had never used Glass before. 4 wore prescription glasses, which may have affected their task performance \claire{ as the glasses beneath Glass make it more cumbersome to secure the position of the Glass and to adjust the screen to the optimal angle.} Half of them performed {\em infrared} mode first and the other half did {/em list} mode first.
