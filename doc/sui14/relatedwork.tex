...
rely on computer-vision recognition of printed tags on devices. Unfortunately, these methods either impose significant constraints
on the camera used for detection, or require large, obtrusive tags, and
inevitably lack feedback from passive markers in the environment. \bjoern{need a better reference than bokode that uses QR codes for initiating interaction.}
...
\bjoern{I tried to fold in some of the points about QR codes into the text above.}
