...
\toappear{Submitted for review to UIST 2014.}
...
\teaser{
  ...
  \caption{{\em Left}: Our head orientation-based selection techniques uses an IR emitter -- multiple targets may fall within its illumination area. {\em Center}: We offer two list-based refinement techniques - {\em Naive IR} uses alphabetical ordering; {\em Intensity IR} orders by received light intensity. {\em Right}: Alternatively, users can refine their selection through head orientation refinement in a quasi-mode.}
  \label{fig:teaser}
}
...
\keywords{
  Wearable computing; selection; glass; infared
}
