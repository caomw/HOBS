...
%
We set the devices up in a simulated living room environment and invited 14 users to step through a predefined set of tasks to control the appliances at a distance. \changes{The tasks include turning off a lamp, playing a movie and turning up the volume.} 
