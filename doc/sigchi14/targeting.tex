...
We first show results for 10 targets and then discuss extrapolations of these results. Average target acquisition time $t_{infrared}$ was 6.67 seconds, while $t_{list}$ was 8.86 seconds (Figure~\ref{fig:selection-times} {\em (left)}). This difference is significant (Student's t-test, p=0.00017). \bjoern{you need to report the t statistic and degrees of freedom as well - t(df)= n,p=m.} 
